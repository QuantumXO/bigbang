...
import { MimTokenContract, ZapinContract } from "../../services/abi";
import { calculateUserBondDetails, fetchAccountSuccess } from "./account-slice";
import { IAllBondData } from "../../services/hooks/bonds";
import { zapinData, zapinLpData } from "../../services/helpers/zapin-fetch-data";
import { trim } from "../../services/helpers/trim";
...
export const calcZapinDetails = async ({
                                         token,
                                         provider,
                                         networkID,
                                         bond,
                                         ...
                                         slippage,
                                         dispatch
                                       }: ITokenZapin): Promise<ITokenZapinResponse> => {
