...
export const AVAX_NETWORK: IBlockchain.INetwork = {
  ...
  tokens: [
    ...
    { id: 'BIGwAVAX', address: '0x63844aa5655637885e7CeAeE1A438206Cfd24845', tokenNativeCurrencyLPAddress: '0x63844aa5655637885e7CeAeE1A438206Cfd24845' },
    // { id: 'YEL', address: '0xD3b71117E6C1558c1553305b44988cd944e97300', tokenNativeCurrencyLPAddress: '' },
  ],
  bondAddresses: {
    BIG_ADDRESS: '0x7ce5DB1b99855BE3505D15d510df85fB3e87be39',
    BANG_ADDRESS: '0x27143aF2E93133f6b85DAffCFB7237C720693539',
    DYEL_ADDRESS: '0xb166F0C86BAD9DEeE3A788106F49F975333DCF09',
