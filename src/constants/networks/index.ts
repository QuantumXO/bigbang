...
import ETH_NETWORK from '@constants/networks/eth';

export const DEFAULT_NETWORK = FTM_NETWORK;
export const NETWORKS: IBlockchain.INetwork[] = [FTM_NETWORK, MATIC_NETWORK, BSC_NETWORK, AVAX_NETWORK, ETH_NETWORK];
