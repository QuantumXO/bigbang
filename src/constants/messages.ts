export const messages = {
  please_connect: 'Please connect your wallet to the correct network to use App.',
  ...
  pls_enter_dyel_amount: 'Please enter dYel amount',
  pls_switch_to_correct_network: 'Please switch to correct network',
